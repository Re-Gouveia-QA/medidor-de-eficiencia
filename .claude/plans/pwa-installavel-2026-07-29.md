...
**Date:** 2026-07-29
**Status:** Fase 1 concluída em `feature/pwa-manifest-icons`; Fase 2 concluída em
`feature/pwa-service-worker` (branch independente a partir de `master`, não de cima da Fase 1 —
service worker não depende do manifest/ícones pra funcionar). Nenhuma das duas mesclada ainda —
merge só mediante pedido explícito.
